...
3. Review the supported embedding models and their dimensions in [services/multimodal-embedding/docs/user-guide/supported-models.md](../../../../services/multimodal-embedding/docs/user-guide/supported-models.md) before switching models.
